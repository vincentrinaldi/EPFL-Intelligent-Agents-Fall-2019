...
public class ReactiveRLA implements ReactiveBehavior {
	...
	public Action act(Vehicle vehicle, Task availableTask) {
		...
		// The agent will always check if the best action is to pick or ignore an available task at his location
		if (availableTask != null && vehicleLocation == availableTask.pickupCity) {
